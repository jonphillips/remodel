...
model={
 ...
 'assumptions':{
  ...
  'table':'Preserved normal-extension capsule registration; four chair poses assumed. TC chair dimensions measured; other poses reuse them as proxies.',
...
state['checkpoint']='2026-09-14 current task: collinearity confirmed; paired connection study created.'
